...
package com.navercorp.eventeria.messaging.arbitrary;
...
public class ArbitraryUtils {
	...
	public static Arbitrary<String> sourceId() {
		return uuid().map(UUID::toString);
	}

	public static Arbitrary<Long> sourceVersion() {
	...
	public static Arbitrary<Instant> currentTime() {
		return Arbitraries.randomValue(r -> Instant.now());
	}
}
